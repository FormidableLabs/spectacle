...
|contentHeight| PropTypes.string or PropTypes.number| Baseline content area height (default: 700)
|contentWidth| PropTypes.string or PropTypes.number| Baseline content area width (default: 1000)
