...
function (_Component) {
  ...
  function TableHeaderItem() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TableHeaderItem).apply(this, arguments));
  }
  ...
  _createClass(TableHeaderItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(StyledTableHeaderItem, {
        className: this.props.className,
        styles: [this.context.styles.components.tableHeaderItem, getStyles.call(this), typefaceStyle, this.props.style]
      }, this.props.children);
    }
  }]);
