...
function (_Component) {
  ...
  _createClass(BlockQuote, [{
    ...
    value: function render() {
      var styles = [this.context.styles.components.blockquote, getStyles.call(this), this.context.typeface || {}, this.props.style];
      return React.createElement(StyledBlockQuote, {
