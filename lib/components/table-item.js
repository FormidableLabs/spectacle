...
function (_Component) {
  ...
  _createClass(TableItem, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(StyledTableItem, {
        className: this.props.className,
        styles: [this.context.styles.components.tableItem, _base.getStyles.call(this), typefaceStyle, this.props.style]
      }, this.props.children);
    }
  }]);
